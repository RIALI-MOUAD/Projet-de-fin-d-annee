...
def output(request):
    ...
    COVID19_PARAMS = {
        "r0": Predict.r0,
        "incubation": Predict.incubation,
        "percent_mild": Predict.percent_mild,
        "mild_recovery": (Predict.mild_recoveryMin, Predict.mild_recoveryMax),
        "percent_severe": Predict.percent_severe,
        "severe_recovery": (Predict.severe_recoveryMin, Predict.severe_recoveryMin),
        "severe_death": (Predict.severe_deathMin, Predict.severe_deathMax),
        "fatality_rate": Predict.fatality_rate,
        "serial_interval": Predict.serial_interval
    }
    ...
    return render(request, 'templates/Predict/uploadP.html',{})